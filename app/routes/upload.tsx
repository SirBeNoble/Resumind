...
const upload = () => {
    ...
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file }: { companyName: string, jobTitle: string, jobDescription: string, file: File}) => {
        ...
        if(!imageFile.file) return setStatusText("PDF to image conversion failed. Please try again.");
        ...
        setStatusText("Analyzing with AI... (this may take a while)");
  ...
  return (
    ...
    <section className="main-section">
        <div className="page-heading py-16">
            ...
            {!isProcessing && (
                <form id="upload-form" onSubmit={handleSubmit} className="flex flex-col gap-4 mt-8 items-center">
